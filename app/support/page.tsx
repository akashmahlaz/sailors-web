...
export const metadata: Metadata = {
  title: "Sailor Support - Sailor's platform",
  description: "Submit a confidential support request to the ship's officers",
}

export default function SupportPage() {
  return (
    <div className="container mx-auto px-4 py-8 bg-gradient-to-b from-slate-50 to-amber-50 dark:from-slate-950 dark:to-gray-500 min-h-screen">
